...
public class GameProcess3States {
	...
	public GameProcess3States(int[][] startConfigMatrix) {
		...
		this.changedConfigMatrix = Solver3States.copyOfMatrix(startConfigMatrix);
		this.userSteps = 0;
		this.score = 0;
		this.timesOfShowingSolution = 0;
		this.currentOptimalSolution = null;
		this.optimalSteps = Solver3States.getStepsOptimalSolution(startConfigMatrix);
	}
	...
	public void findCurrentSolution() {
		...
		this.currentOptimalSolution = Solver3States.getOptimalSolution(changedConfigMatrix);	
	}
